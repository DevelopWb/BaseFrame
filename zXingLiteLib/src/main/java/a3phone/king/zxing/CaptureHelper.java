...
import a3phone.king.zxing.camera.CameraManager;
import a3phone.king.zxing.camera.FrontLightMode;
import a3phone.king.zxing.util.LogUtils;
...
public class CaptureHelper implements CaptureLifecycle, CaptureTouchEvent, CaptureManager, SurfaceHolder.Callback {
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            if (captureHandler == null) {
                captureHandler = new CaptureHandler(activity, viewfinderView, onCaptureListener, decodeFormats,
