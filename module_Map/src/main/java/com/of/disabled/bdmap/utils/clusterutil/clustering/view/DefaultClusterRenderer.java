...
package com.of.disabled.bdmap.utils.clusterutil.clustering.view;
...
import com.of.disabled.bdmap.R;
import com.of.disabled.bdmap.utils.clusterutil.MarkerManager;
import com.of.disabled.bdmap.utils.clusterutil.clustering.Cluster;
import com.of.disabled.bdmap.utils.clusterutil.clustering.ClusterItem;
import com.of.disabled.bdmap.utils.clusterutil.clustering.ClusterManager;
import com.of.disabled.bdmap.utils.clusterutil.projection.Point;
import com.of.disabled.bdmap.utils.clusterutil.projection.SphericalMercatorProjection;
import com.of.disabled.bdmap.utils.clusterutil.ui.IconGenerator;
...
import static com.of.disabled.bdmap.utils.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.of.disabled.bdmap.utils.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private com.of.disabled.bdmap.utils.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        com.of.disabled.bdmap.utils.clusterutil.ui.SquareTextView squareTextView =
                new com.of.disabled.bdmap.utils.clusterutil.ui.SquareTextView(context);
...
//        return BUCKETS[BUCKETS.length - 1];
    ...
    private class CreateMarkerTask {
         ...
         * @param animateFrom  the location_icon to animate the markerWithPosition from, or null if no
