...
package com.of.disabled.bdmap.utils.clusterutil.clustering.algo;
...
import com.of.disabled.bdmap.utils.clusterutil.projection.Bounds;
...
import com.of.disabled.bdmap.utils.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public void removeItem(T item) {
        // : delegate QuadItem#hashCode and QuadItem#equals to its item.
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.of.disabled.bdmap.utils.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.of.disabled.bdmap.utils.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.of.disabled.bdmap.utils.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.of.disabled.bdmap.utils.clusterutil.clustering.algo
