...
import com.of.disabled.basecomponent.net.FileRetrofit;
...
import com.of.disabled.basecomponent.widght.BaseBottomDialog;
            ...
            if (rightName.contains("视频")) {
                ...
                getTitleRightTv().setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        initBottomDialog(getBaseBottomDialogMenus(getTitleRightName()), getDownLoadPath());
                    }
                });
            }
        }
