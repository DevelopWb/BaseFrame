...
public class ItemFragmentBean {
    ...
    public ItemFragmentBean(String title,int mSpanCount, int mMaxCount, int minCount,
    ...
    public ItemFragmentBean(int mSpanCount, int mMaxCount, int minCount, int type,
                            List<String> fragmentPics) {
        this.mSpanCount = mSpanCount;
        this.mMaxCount = mMaxCount;
        this.minCount = minCount;
