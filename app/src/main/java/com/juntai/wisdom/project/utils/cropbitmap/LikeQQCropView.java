package com.juntai.wisdom.project.utils.cropbitmap;
...
//        circlePath.addCircle(centerX, centerY,circleRectFLength/2, Path.Direction.CW);
    ...
    private void refreshPath() {
        ...
        RectF circleBorderRectF = new RectF(
                circleRectF.left+ getPathInterval(),
                circleRectF.top+ getPathInterval(),
                circleRectF.right- getPathInterval(),
                circleRectF.bottom- getPathInterval());

        circleBorderPath.addRoundRect(
                circleBorderRectF,
